...
public class SortDAO extends HibernateDaoSupport {
	...
	public Sort findById(java.lang.Integer id) {
		...
		try {
			Sort instance = (Sort) getHibernateTemplate().get(
					"com.sedg.entity.Sort", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List findByArticleNum(Object articleNum) {
		return findByProperty(ARTICLE_NUM, articleNum);
	}
