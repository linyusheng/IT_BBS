...
<body>
    ...
    <div class="body">
        ...
        <div class="body_right">
            ...
            <div class="post_tab">
            	<ul>
                	<li><a href="${pageContext.request.contextPath}/askProblem?userId=<s:property value="user.userId"/>">提问(<s:property value="postColl.size()"/>)</a></li>
                    <li class="on"><a href="${pageContext.request.contextPath}/answerProblem?userId=<s:property value="user.userId"/>">回答(<s:property value="replyColl.size()"/>)</a></li>
                </ul>
            </div>
            <table>
            	<thead>
