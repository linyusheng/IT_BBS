...
<%@ include file="header.jsp"%>
    <div class="body">
        ...
        <div class="body_right">
            ...
            <div class="post_tab">
            	<ul>
                	<li class="on"><a href="${pageContext.request.contextPath}/myAsk">提问(<s:property value="postColl.size()"/>)</a></li>
                    <li><a href="${pageContext.request.contextPath}/myAnswer">回答(<s:property value="replyColl.size()"/>)</a></li>
                </ul>
            </div>
            <table>
            	<thead>
